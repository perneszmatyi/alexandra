    ...
    <section className="bg-white-text pr-11 pb-25 pl-9 lg:pl-30">
      <div className="flex w-full flex-col gap-6 lg:flex-row">
        ...
        <div className="w-full">
          <div className="w-full xl:max-w-[600px] 2xl:max-w-[700px]">
            <form className="bg-blue-main z-99 flex flex-col gap-3 rounded-3xl px-5 py-6 shadow-[0.5rem_0.625rem_0_0_#A6CCDE] lg:gap-6 lg:px-9 lg:py-7 lg:shadow-[0.8rem_0.8rem_0_0_#A6CCDE] xl:gap-8 xl:px-11 xl:py-8 xl:shadow-[1rem_1rem_0_0_#A6CCDE]">
